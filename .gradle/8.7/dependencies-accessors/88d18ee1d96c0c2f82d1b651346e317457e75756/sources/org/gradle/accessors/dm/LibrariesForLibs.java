...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final Gun0912LibraryAccessors laccForGun0912LibraryAccessors = new Gun0912LibraryAccessors(owner);
    ...
    /**
     * Group of libraries at <b>gun0912</b>
     */
    public Gun0912LibraryAccessors getGun0912() {
        return laccForGun0912LibraryAccessors;
    }
    ...
    public static class GithubLibraryAccessors extends SubDependencyFactory {
        private final GithubBumptechLibraryAccessors laccForGithubBumptechLibraryAccessors = new GithubBumptechLibraryAccessors(owner);

        public GithubLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.bumptech</b>
         */
        public GithubBumptechLibraryAccessors getBumptech() {
            return laccForGithubBumptechLibraryAccessors;
        }

    }

    public static class GithubBumptechLibraryAccessors extends SubDependencyFactory {
        private final GithubBumptechGlideLibraryAccessors laccForGithubBumptechGlideLibraryAccessors = new GithubBumptechGlideLibraryAccessors(owner);

        public GithubBumptechLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>github.bumptech.glide</b>
         */
        public GithubBumptechGlideLibraryAccessors getGlide() {
            return laccForGithubBumptechGlideLibraryAccessors;
        }

    }

    public static class GithubBumptechGlideLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {

        public GithubBumptechGlideLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> asProvider() {
            return create("github.bumptech.glide");
        }
        ...
        public Provider<MinimalExternalModuleDependency> getCompiler() {
            return create("github.bumptech.glide.compiler");
        }

    }

    public static class Gun0912LibraryAccessors extends SubDependencyFactory {
        private final Gun0912TedLibraryAccessors laccForGun0912TedLibraryAccessors = new Gun0912TedLibraryAccessors(owner);

        public Gun0912LibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>gun0912.ted</b>
         */
        public Gun0912TedLibraryAccessors getTed() {
            return laccForGun0912TedLibraryAccessors;
        }

    }

    public static class Gun0912TedLibraryAccessors extends SubDependencyFactory {

        public Gun0912TedLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Dependency provider for <b>tedkeyboardobserver</b> with <b>gun0912.ted:tedkeyboardobserver</b> coordinates and
         * with version reference <b>tedkeyboardobserver</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         */
        public Provider<MinimalExternalModuleDependency> getTedkeyboardobserver() {
            return create("gun0912.ted.tedkeyboardobserver");
        }

    }

    public static class MeLibraryAccessors extends SubDependencyFactory {
        private final MeRelaxLibraryAccessors laccForMeRelaxLibraryAccessors = new MeRelaxLibraryAccessors(owner);

        public MeLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Group of libraries at <b>me.relax</b>
         */
        public MeRelaxLibraryAccessors getRelax() {
            return laccForMeRelaxLibraryAccessors;
        }

    }

    public static class MeRelaxLibraryAccessors extends SubDependencyFactory {

        public MeRelaxLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getCircleindicator() {
            return create("me.relax.circleindicator");
        }
    ...
    public static class SquareupRetrofitLibraryAccessors extends SubDependencyFactory implements DependencyNotationSupplier {
        private final SquareupRetrofitConverterLibraryAccessors laccForSquareupRetrofitConverterLibraryAccessors = new SquareupRetrofitConverterLibraryAccessors(owner);
        private final SquareupRetrofitLoggingLibraryAccessors laccForSquareupRetrofitLoggingLibraryAccessors = new SquareupRetrofitLoggingLibraryAccessors(owner);
        ...
        /**
         * Group of libraries at <b>squareup.retrofit.converter</b>
         */
        public SquareupRetrofitConverterLibraryAccessors getConverter() {
            return laccForSquareupRetrofitConverterLibraryAccessors;
        }

        /**
         * Group of libraries at <b>squareup.retrofit.logging</b>
         */
        public SquareupRetrofitLoggingLibraryAccessors getLogging() {
            return laccForSquareupRetrofitLoggingLibraryAccessors;
        }

    }

    public static class SquareupRetrofitConverterLibraryAccessors extends SubDependencyFactory {

        public SquareupRetrofitConverterLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getGson() {
            return create("squareup.retrofit.converter.gson");
        }

    }

    public static class SquareupRetrofitLoggingLibraryAccessors extends SubDependencyFactory {

        public SquareupRetrofitLoggingLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }
        ...
        public Provider<MinimalExternalModuleDependency> getInterceptor() {
            return create("squareup.retrofit.logging.interceptor");
        }
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>compiler</b> with value <b>4.13.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>navVersion</b> with value <b>2.7.4</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
        ...
        /**
         * Version alias <b>tedkeyboardobserver</b> with value <b>1.0.1</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getTedkeyboardobserver() { return getVersion("tedkeyboardobserver"); }
